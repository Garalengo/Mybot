// 小柘表柘：https://endway.org/@forch

const TelegramBot = require('node-telegram-bot-api');
const sqlite3 = require('sqlite3').verbose();

// ✅ ТОКЕН: сначала из переменной окружения, потом из config.json
const token = process.env.BOT_TOKEN || require('./config.json').telegramBotToken;
